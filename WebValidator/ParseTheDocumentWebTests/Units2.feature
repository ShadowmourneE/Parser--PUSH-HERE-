...
Scenario: Unit 28
 ...
 Scenario: Unit 29
	...
	Given I have entered:
                         ...
                         1 asdkjfakjsdfakjsdf
                         2  asdfasdfa all of the following:
                         2.1 one of the following: ad;lsfakdhldasfkjazxcvzxcvzxcvzxcv aasdhflasd
                         """
	When parse
	Then the line 4 should have message: This criteria contains long word
 Scenario: Unit 30
	...
	Given I have entered:
                         ...
                         1 asdkjfakjsdfakjsdf
                         2  asdfasdfa all of the following:
                         2.1 one of the following following: ad;lsfakdhldasfkjazxcvzxcvzxcvzxcv aasdhflasd
                         """
	When parse
	Then the line 4 should have message: This criteria contains repeating words
